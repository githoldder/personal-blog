...
把 Personal Knowledge Asset OS 的公开展示层打磨到可发布状态，完善响应式体验、搜索订阅、性能 SEO 和发布前检查。

## Phase Mapping

对应大目标 **Phase 4: Polish**。
...
1. 核心页面在移动端与桌面端可用且无明显文字重叠。
2. 导航、视觉系统与工作台定位保持一致。
3. 搜索索引和订阅源都由本地内容真源生成。
4. SEO、sitemap、robots 与性能风险有发布前报告。
5. 不经明确授权，不执行外部部署或发布。
